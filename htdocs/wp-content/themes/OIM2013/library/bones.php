...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/scripts.min.js', array( 'jquery', 'jq-form-plugin', 'simplyscroll-js', 'superfish-js', 'hoverintent-js' ), '', true );
